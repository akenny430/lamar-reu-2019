...
rownames(lasso_inf) = "colon_lasso"
...
rownames(enet_inf) = paste("colon_enet_mod", 1:la, sep = "")
...
rownames(pcl_inf) = paste("colon_pcl_no_mod", 1:la, sep = "")
...
rownames(glask_inf) = "colon_glas_k"
...
rownames(glash_inf) = "colon_glas_h"
...
rownames(cmcpk_inf) = paste("colon_cmcp_k_mod", 1:la, sep = "")
...
rownames(cmcph_inf) = paste("colon_cmcp_h_mod", 1:la, sep = "")
...
rownames(sglk_inf) = paste("colon_sgl_k_mod", 1:la, sep = "")
...
rownames(sglh_inf) = paste("colon_sgl_h_mod", 1:la, sep = "")
...
rownames(pclk_inf) = paste("colon_pcl_k_mod", 1:la, sep = "")
...
rownames(pclh_inf) = paste("colon_pcl_h_mod", 1:la, sep = "")
...
colon_results = rbind(lasso_inf, enet_inf, pcl_inf, 
                      glask_inf, sglk_inf, 
                      cmcpk_inf, pclk_inf, 
                      glash_inf, sglh_inf, 
                      cmcph_inf, pclh_inf)
write.csv(colon_results, file = "colon_results.csv")

# results for the best models
colon_best = rbind(lasso_inf, enet_best, pcl_best, 
                   glask_inf, sglk_best, 
                   cmcpk_best, pclk_best, 
                   glash_inf, sglh_best, 
                   cmcph_best, pclh_best)
write.csv(colon_best, file = "colon_best.csv")
...
```{r LaTeX table}
#lt = read.csv("colon_best.csv", header = TRUE)
#lt = lt[, -1]
