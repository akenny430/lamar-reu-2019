...
\setbeamercolor*{palette primary}{bg = DodgerBlue1, fg = white}
%\usepackage{color}
...
\title{Summer REU Experience}
\author{}
\institute{\includegraphics[width = 0.25\textwidth]{lamar_seal.png}}
\date{Aiden Kenny\\[0.5pt]
Franklin \&{} Marshall College\\[0.5pt]
September 26, 2019}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.95\textwidth]{group.JPG}
    %\caption{Caption}
    %\label{fig:my_label}
\end{figure}
...
\begin{itemize}
    \item What our research was about. 
    \item What ``research'' is like.
    \item Social aspects.
    \item How to apply to REUs.
\end{itemize}
...
\begin{figure}
    \centering
    %\includegraphics[trim = 50 50 0 50, clip, width = 0.3\textwidth]{min_nll.pdf}
...
\begin{center}
    ...
    %\animategraphics[autoplay, loop, width = 0.3\textwidth]{30}{enet_ani_merged}{}{}
\end{center}
...
\begin{itemize}
    ...
    \item However, the lasso might select genes that are not in significant pathways! %\Sadey[1.5][yellow]
\end{itemize} \mys
...
\begin{figure}
    \centering
    \textcolor{white}{\frame{\includegraphics[width = 0.3175\textwidth, angle = 0, origin = c]{roach.JPG}}} \hspace{0.5cm}
    \textcolor{white}{\frame{\includegraphics[width = 0.45\textwidth, angle = 270, origin = c]{drain.JPG}}}
    %\caption{Caption}
    %\label{fig:my_label}
\end{figure}
